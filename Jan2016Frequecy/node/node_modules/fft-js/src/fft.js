...
module.exports = {
  ...
  fft: function fft(vector) {
    ...
    for (var k = 0; k < N / 2; k++) {
      ...
      //console.log("exponent: " + fftUtil.exponent(k, N));
      //console.log("odds: " + X_odds[k]);
      //console.log("evens: " + X_evens[k]);
      //console.log("length: " + X_odds.length);
      //console.log(("odds length: " + X_evens.length));
